...
#define PRINT_FUNC_RETURN(func_name, is_void) {print_func_return_error(func_name, line_with_return, is_void); return ER_FUNC_RETURN;}
...
#define PRINT_INTERNAL(msg) {print_internal_error(data, msg); return ER_INTERNAL;}
